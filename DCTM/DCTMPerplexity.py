...
def dctm_perplexity(read_directory1, read_directory2, read_directory3, write_filename):
...
if __name__ == '__main__':
    ...
    read_directory1 = root_directory + u'dataset/DCTM/mctrwdctm_doc_ct100'
    read_directory2 = root_directory + u'dataset/DCTM/mctrwdctm_ct_word100'
    read_directory3 = root_directory + u'dataset/text_model/vsm'
    
    write_filename = root_directory + u'dataset/DCTM/dctm_perplexity100.txt'
    
    dctm_perplexity(read_directory1, read_directory2, read_directory3, write_filename)
