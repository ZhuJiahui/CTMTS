...
if __name__ == '__main__':
    ...
    read_directory1 = root_directory + u'dataset/DCTM/doc_topic100'
    read_directory2 = root_directory + u'dataset/DCTM/topic_word100'
    write_directory1 = root_directory + u'dataset/DCTM/mctrwctm_doc_ct100'
    write_directory2 = root_directory + u'dataset/DCTM/mctrwctm_ct_word100'
    write_directory3 = root_directory + u'dataset/DCTM/mctrwctm_ct_number100'
    write_filename1 = root_directory + u'dataset/DCTM/mctrwctm_ct_time100.txt'
    write_filename2 = root_directory + u'dataset/DCTM/mctrwctm_cn100.txt'
