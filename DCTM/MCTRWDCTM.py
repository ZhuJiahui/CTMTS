...
from DCTM.SpectralCluster import spectral_cluster2, spectral_cluster
...
if __name__ == '__main__':
    ...
    write_directory1 = root_directory + u'dataset/DCTM/mctrwdctm_doc_ct'
    write_directory2 = root_directory + u'dataset/DCTM/mctrwdctm_ct_word'
    write_directory3 = root_directory + u'dataset/DCTM/mctrwdctm_ct_number'
    write_filename = root_directory + u'dataset/DCTM/mctrwdctm_time.txt'
