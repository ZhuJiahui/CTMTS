...
if __name__ == '__main__':
    ...
    write_directory1 = root_directory + u'dataset/DCTM/tf_corpus150'
    write_directory2 = root_directory + u'dataset/DCTM/doc_topic150'
    write_directory3 = root_directory + u'dataset/DCTM/topic_word150'
