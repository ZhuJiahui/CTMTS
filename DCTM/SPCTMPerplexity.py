...
if __name__ == '__main__':
    ...
    read_directory1 = root_directory + u'dataset/DCTM/spctm_doc_ct'
    read_directory2 = root_directory + u'dataset/DCTM/spctm_ct_word'
    read_directory3 = root_directory + u'dataset/text_model/vsm'
    
    write_filename = root_directory + u'dataset/DCTM/spctm_perplexity.txt'
