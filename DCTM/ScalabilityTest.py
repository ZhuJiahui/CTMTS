...
def get_scalability(read_directory1, read_filename1, read_filename2, read_filename3, write_filename):
    ...
    for i in range(file_number):
        ...
        temp_time1 += float(time_list1[i])
        temp_time2 += float(time_list2[i])
        temp_time3 += float(time_list3[i])
        
        if temp_weibo >= (50000 * count):
...
if __name__ == '__main__':
    ...
    read_directory1 = root_directory + u'dataset/DCTM/mctrwctm_doc_ct'
    read_filename1 = root_directory + u'dataset/DCTM/mctrwctm_ct_time.txt'
    read_filename2 = root_directory + u'dataset/DCTM/mctrwdctm_time2.txt'
    read_filename3 = root_directory + u'dataset/DCTM/spctm_ct_time.txt'
    
    write_filename = root_directory + u'dataset/DCTM/scalability.txt'
