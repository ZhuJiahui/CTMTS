...
if __name__ == '__main__':
    ...
    write_directory = root_directory + u'dataset/text_model2'
    write_directory1 = root_directory + u'dataset/text_model2/time'
    write_directory2 = root_directory + u'dataset/text_model2/content1'
    write_directory3 = root_directory + u'dataset/text_model2/content2'
    write_directory4 = root_directory + u'dataset/text_model2/class_tag'
    write_directory5 = root_directory + u'dataset/text_model2/all_weibo_word'
