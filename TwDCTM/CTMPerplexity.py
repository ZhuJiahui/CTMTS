...
def ctm_perplexity(read_directory1, read_directory2, read_directory3, write_filename):
...
if __name__ == '__main__':
    ...
    read_directory1 = root_directory + u'dataset2/DCTM/mctrwctm_doc_ct60'
    read_directory2 = root_directory + u'dataset2/DCTM/mctrwctm_ct_word60'
    read_directory3 = root_directory + u'dataset2/text_model/vsm'
    
    write_filename = root_directory + u'dataset2/DCTM/ctm_perplexity60.txt'
    
    ctm_perplexity(read_directory1, read_directory2, read_directory3, write_filename)
