...
def lda_perplexity(read_directory1, read_directory2, read_directory3, write_filename):
    ...
    for i in range(424, 449):
        ...
        #p_doc_word = 0.05 * np.dot(THETA, PHAI)
        p_doc_word = 0.05 * np.dot(THETA, PHAI)
        ...
        for j in range(len(p_doc_word)):
            ...
            for k in range(len(p_doc_word[0])):
                if vsm[j][k] > 0.00001 and p_doc_word[j][k] > 0.00001:
...
if __name__ == '__main__':
    ...
    #read_directory1 = root_directory + u'dataset2/DCTM/clda_doc_topic20'
    #read_directory2 = root_directory + u'dataset2/DCTM/clda_topic_word20'
    
    read_directory3 = root_directory + u'dataset2/text_model/vsm'
    
    write_filename = root_directory + u'dataset2/DCTM/lda_perplexity60.txt'
    #write_filename = root_directory + u'dataset2/DCTM/clda_perplexity20.txt'
    
    lda_perplexity(read_directory1, read_directory2, read_directory3, write_filename)
