...
if __name__ == '__main__':
    ...
    read_directory1 = root_directory + u'dataset2/DCTM/mctrwctm_ct_word60'
    read_directory2 = root_directory + u'dataset2/DCTM/mctrwdctm_ct_word60'
    read_directory3 = root_directory + u'dataset2/DCTM/spctm_ct_word60'
    read_directory4 = root_directory + u'dataset2/DCTM/topic_word60'
    
    write_filename1 = root_directory + u'dataset2/DCTM/ctm_td60.txt'
    write_filename2 = root_directory + u'dataset2/DCTM/dctm_td60.txt'
    write_filename3 = root_directory + u'dataset2/DCTM/spctm_td60.txt'
    write_filename4 = root_directory + u'dataset2/DCTM/lda_td60.txt'
