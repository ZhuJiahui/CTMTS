...
if __name__ == '__main__':
    ...
    write_directory1 = root_directory + u'dataset2/prediction'
    write_directory = root_directory + u'dataset2/prediction/topic_intensity'
    
    read_directory = root_directory + u'dataset2/DCTM/mctrwctm_doc_ct20'
    read_directory2 = root_directory + u'dataset2/DCTM/mctrwctm_ct_word20'
